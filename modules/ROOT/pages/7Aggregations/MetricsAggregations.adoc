...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-min-aggregation.html[最小值聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-max-aggregation.html[最大值聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-sum-aggregation.html[求和聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-avg-aggregation.html[平均值聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-stats-aggregation.html[统计聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-extendedstats-aggregation.html[拓展统计聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-valuecount-aggregation.html[值计数(value count)聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-percentile-aggregation.html[百分比聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-percentile-rank-aggregation.html[百分比等级聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-cardinality-aggregation.html[基数聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-geobounds-aggregation.html[地理界限聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-top-hits-aggregation.html[热门聚合] 。
...
你可以通过JavaAPI使用 https://www.elastic.co/guide/en/elasticsearch/reference/5.6/search-aggregations-metrics-scripted-metric-aggregation.html[脚本指标聚合] 。
