...
有关索引操作的更多信息，请查阅REST https://www.elastic.co/guide/en/elasticsearch/reference/6.2/docs-index_.html[index] 文档( https://www.elastic.co/guide/cn/elasticsearch/guide/current/index-doc.html[中文])。
